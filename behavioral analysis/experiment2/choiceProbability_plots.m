...
title({'Experiment 2','learning phase'})
set(gcf,'color','w')
box off
print(gcf,fullfile(fig_path,'ChoiceProb_Exp2learning.eps'),'-depsc2','-painters');
...
ylabel('choice probability')
xlabel('trials after rule change')
title({'Experiment 2','transfer phase'})
set(gcf,'color','w')
box off
print(gcf,fullfile(fig_path,'ChoiceProb_Exp2transfer.eps'),'-depsc2','-painters');
