...
files = dir('C:/Users/Tanya Wen/Box/Home Folder tw260/Private/meta-flexibility/Pilots/mturk/short/version1/pilot2/*.log');
...
xticklabels({'CP','CN','IP','IN'})
ylabel('number of trials')
print(gcf,fullfile(fig_path,'BehavBreakdown_Exp1learning.eps'),'-depsc2','-painters');
...
xticklabels({'CP','CN','IP','IN'})
ylabel('number of trials')
print(gcf,fullfile(fig_path,'BehavBreakdown_Exp1transfer.eps'),'-depsc2','-painters');
