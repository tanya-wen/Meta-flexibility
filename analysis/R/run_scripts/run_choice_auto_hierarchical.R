...
print(model_fit, pars=c("eta_mu", "eta_sigma", "beta_mu", "beta_sigma", "phi_mu", "phi_sigma", "theta_mu", "theta_sigma", "alpha_mu", "alpha_sigma", "group_effect_eta", "group_effect_beta", "group_effect_phi", "group_effect_theta", "starting_utility"), probs=c(.1,.5,.9))

traceplot(model_fit, pars = c("eta_mu", "eta_sigma", "beta_mu", "beta_sigma", "phi_mu", "phi_sigma", "theta_mu", "theta_sigma", "alpha_mu", "alpha_sigma", "group_effect_eta", "group_effect_beta", "group_effect_phi", "group_effect_theta", "starting_utility"), inc_warmup = TRUE, nrow = 2)

# hyperparameters posterior distributions
stan_hist(model_fit, pars = c("eta_mu", "eta_sigma", "beta_mu", "beta_sigma", "phi_mu", "phi_sigma", "theta_mu", "theta_sigma", "alpha_mu", "alpha_sigma", "group_effect_eta", "group_effect_beta", "group_effect_phi", "group_effect_theta", "starting_utility"))
