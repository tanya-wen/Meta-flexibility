...
print(model_fit, pars=c("eta_mu","eta_sigma","beta_mu","beta_sigma","gamma_mu","gamma_sigma","alpha_mu","alpha_sigma","omega_mu","omega_sigma","group_effect_eta","group_effect_beta","group_effect_gamma","starting_utility"), probs=c(.1,.5,.9))

traceplot(model_fit, pars = c("eta_mu", "eta_sigma","beta_mu","beta_sigma","gamma_mu","gamma_sigma","starting_utility"), inc_warmup = TRUE, nrow = 2)

# hyperparameters posterior distributions
stan_hist(model_fit, pars = c("eta_mu", "eta_sigma","beta_mu","beta_sigma","alpha_mu","alpha_sigma","group_effect_eta","group_effect_beta","starting_utility"))
