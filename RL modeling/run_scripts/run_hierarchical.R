...
allSubjects_data <- allSubjects %>% 
  ...
  mutate(picked_rule = ifelse(madeChoice == 0, 0, # if madeChoice = 0, set picked_rule to 0
                              ifelse(phase == 1, ifelse(as.character(type) == type[1], ifelse(as.character(answer) == as.character(response), 1, 2), # if madeChoice = 1 && if phase = 1 && if current rule is the same as first rule (e.g., first trial = color, current trial = color) if answer is the same as response, set picked_rule to 1 else set to 2
                                                         ifelse(as.character(answer) == as.character(response), 2, 1)), # if madeChoice = 1 && if phase = 1 && if current rule is different from the first rule (e.g., first trial = color, current trial = shape), if answer is the same as response, set picked_rule to 2 else set to 1
                              ifelse(as.character(type) == type[121], ifelse(as.character(answer) == as.character(response), 1, 2), # if madeChoice = 1 && if phase = 2 && if current rule is the same as first rule (e.g., first trial = race, current trial = race) if answer is the same as response, set picked_rule to 1 else set to 2
                                     ifelse(as.character(answer) == as.character(response), 2, 1))))) %>% # if madeChoice = 1 && if phase = 2 && if current rule is different from the first rule (e.g., first trial = race, current trial = gender), if answer is the same as response, set picked_rule to 2 else set to 1
...
sum((alpha_mu[ ,2,2,1] - alpha_mu[ ,2,1,1]) - (alpha_mu[ ,2,2,2] - alpha_mu[ ,2,1,2])) / 3400 / 2
quantile((alpha_mu[ ,2,2,1] - alpha_mu[ ,2,1,1]) - (alpha_mu[ ,2,2,2] - alpha_mu[ ,2,1,2]), probs=c(.025,.975)) / 2
# Exp 1 vs Exp 3
sum((alpha_mu[ ,2,2,1] - alpha_mu[ ,2,1,1]) > (alpha_mu[ ,2,2,3] - alpha_mu[ ,2,1,3]), na.rm = TRUE) / 3400 * 100
sum((alpha_mu[ ,2,2,1] - alpha_mu[ ,2,1,1]) - (alpha_mu[ ,2,2,3] - alpha_mu[ ,2,1,3])) / 3400 / 2
quantile((alpha_mu[ ,2,2,1] - alpha_mu[ ,2,1,1]) - (alpha_mu[ ,2,2,3] - alpha_mu[ ,2,1,3]), probs=c(.025,.975)) / 2
# Exp 2 vs Exp 3
sum((alpha_mu[ ,2,2,2] - alpha_mu[ ,2,1,2]) > (alpha_mu[ ,2,2,3] - alpha_mu[ ,2,1,3]), na.rm = TRUE) / 3400 * 100
sum((alpha_mu[ ,2,2,2] - alpha_mu[ ,2,1,2]) - (alpha_mu[ ,2,2,3] - alpha_mu[ ,2,1,3])) / 3400 / 2
quantile((alpha_mu[ ,2,2,2] - alpha_mu[ ,2,1,2]) - (alpha_mu[ ,2,2,3] - alpha_mu[ ,2,1,3]), probs=c(.025,.975)) / 2
...
sum((alpha_mu[ ,2,2,1] + alpha_mu[ ,2,2,2] + alpha_mu[ ,2,2,3]) - 
      (alpha_mu[ ,2,1,1] + alpha_mu[ ,2,1,2] + alpha_mu[ ,2,1,3])) / 3400 / 3
quantile((alpha_mu[ ,2,2,1] + alpha_mu[ ,2,2,2] + alpha_mu[ ,2,2,3]) - 
           (alpha_mu[ ,2,1,1] + alpha_mu[ ,2,1,2] + alpha_mu[ ,2,1,3]), probs=c(.025,.975)) / 3
...
# Experiment 1: compare learning phase vs transfer phase
sum(beta_mu[ ,1,1,1] > beta_mu[ ,2,1,1], na.rm = TRUE) / 3400 * 100 
...
quantile(((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1]) - (beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1])) - ((beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2]) - (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2])),probs=c(.025,.975)) / 4
sum((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1] + (beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1])) > ((beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2]) + (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2])), na.rm = TRUE) / 3400 * 100 #experiment x group (both phase)
sum((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1] + (beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1])) - ((beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2]) + (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2]))) / 3400 / 4
quantile((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1] + (beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1])) - ((beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2]) + (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2])),probs=c(.025,.975)) / 4
quantile((beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1]) - (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2]),probs=c(.025,.975)) / 2
sum((beta_mu[ ,1,2,1] - beta_mu[ ,2,2,1] + (beta_mu[ ,1,1,1] - beta_mu[ ,2,1,1])) > ((beta_mu[ ,1,2,2] - beta_mu[ ,2,2,2]) + (beta_mu[ ,1,1,2] - beta_mu[ ,2,1,2])), na.rm = TRUE) / 3400 * 100 #experiment x phase (both groups)
sum((beta_mu[ ,1,2,1] - beta_mu[ ,2,2,1] + (beta_mu[ ,1,1,1] - beta_mu[ ,2,1,1])) - ((beta_mu[ ,1,2,2] - beta_mu[ ,2,2,2]) + (beta_mu[ ,1,1,2] - beta_mu[ ,2,1,2]))) / 3400 / 4
quantile((beta_mu[ ,1,2,1] - beta_mu[ ,2,2,1] + (beta_mu[ ,1,1,1] - beta_mu[ ,2,1,1])) - ((beta_mu[ ,1,2,2] - beta_mu[ ,2,2,2]) + (beta_mu[ ,1,1,2] - beta_mu[ ,2,1,2])),probs=c(.025,.975)) / 4
# Exp 1 vs Exp 3
...
quantile(((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1]) - (beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1])) - ((beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3]) - (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3])),probs=c(.025,.975)) / 4
sum((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1] + (beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1])) > ((beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3]) + (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3])), na.rm = TRUE) / 3400 * 100 #experiment x group (both phases)
sum((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1] + (beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1])) - ((beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3]) + (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3]))) / 3400 / 4
quantile((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1] + (beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1])) - ((beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3]) + (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3])),probs=c(.025,.975)) / 4
quantile((beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1]) - (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3]),probs=c(.025,.975)) / 2
sum((beta_mu[ ,1,2,1] - beta_mu[ ,2,2,1] + (beta_mu[ ,1,1,1] - beta_mu[ ,2,1,1])) > ((beta_mu[ ,1,2,3] - beta_mu[ ,2,2,3]) + (beta_mu[ ,1,1,3] - beta_mu[ ,2,1,3])), na.rm = TRUE) / 3400 * 100 #experiment x phase (both groups)
sum((beta_mu[ ,1,2,1] - beta_mu[ ,2,2,1] + (beta_mu[ ,1,1,1] - beta_mu[ ,2,1,1])) - ((beta_mu[ ,1,2,3] - beta_mu[ ,2,2,3]) + (beta_mu[ ,1,1,3] - beta_mu[ ,2,1,3]))) / 3400 / 4
quantile((beta_mu[ ,1,2,1] - beta_mu[ ,2,2,1] + (beta_mu[ ,1,1,1] - beta_mu[ ,2,1,1])) - ((beta_mu[ ,1,2,3] - beta_mu[ ,2,2,3]) + (beta_mu[ ,1,1,3] - beta_mu[ ,2,1,3])),probs=c(.025,.975)) / 4
# Exp 2 vs Exp 3
...
quantile(((beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2]) - (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2])) - ((beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3]) - (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3])),probs=c(.025,.975)) / 4
sum((beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2] + (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2])) > ((beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3]) + (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3])), na.rm = TRUE) / 3400 * 100 #experiment x group (both phases)
sum((beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2] + (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2])) - ((beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3]) + (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3]))) / 3400 / 4
quantile((beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2] + (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2])) - ((beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3]) + (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3])),probs=c(.025,.975)) / 4
sum((beta_mu[ ,1,2,2] - beta_mu[ ,2,2,2] + (beta_mu[ ,1,1,2] - beta_mu[ ,2,1,2])) > ((beta_mu[ ,1,2,3] - beta_mu[ ,2,2,3]) + (beta_mu[ ,1,1,3] - beta_mu[ ,2,1,3])), na.rm = TRUE) / 3400 * 100 #experiment x phase (both groups)
sum((beta_mu[ ,1,2,2] - beta_mu[ ,2,2,2] + (beta_mu[ ,1,1,2] - beta_mu[ ,2,1,2])) - ((beta_mu[ ,1,2,3] - beta_mu[ ,2,2,3]) + (beta_mu[ ,1,1,3] - beta_mu[ ,2,1,3]))) / 3400 / 4
quantile((beta_mu[ ,1,2,2] - beta_mu[ ,2,2,2] + (beta_mu[ ,1,1,2] - beta_mu[ ,2,1,2])) - ((beta_mu[ ,1,2,3] - beta_mu[ ,2,2,3]) + (beta_mu[ ,1,1,3] - beta_mu[ ,2,1,3])),probs=c(.025,.975)) / 4
# group x phase
sum(((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1]) + (beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2]) + (beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3])) > 
      ((beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1]) + (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2]) + (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3])), na.rm = TRUE) / 3400 * 100 #group x phase
sum(((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1]) + (beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2]) + (beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3])) - 
      ((beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1]) + (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2]) + (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3]))) / 3400 / 6
quantile(((beta_mu[ ,1,2,1] - beta_mu[ ,1,1,1]) + (beta_mu[ ,1,2,2] - beta_mu[ ,1,1,2]) + (beta_mu[ ,1,2,3] - beta_mu[ ,1,1,3])) - 
      ((beta_mu[ ,2,2,1] - beta_mu[ ,2,1,1]) + (beta_mu[ ,2,2,2] - beta_mu[ ,2,1,2]) + (beta_mu[ ,2,2,3] - beta_mu[ ,2,1,3])),probs=c(.025,.975)) / 6
...
sum((beta_mu[ ,1,2,1] + beta_mu[ ,1,2,2] + beta_mu[ ,1,2,3]) - 
      (beta_mu[ ,1,1,1] + beta_mu[ ,1,1,2] + beta_mu[ ,1,1,3])) / 3400 / 3
quantile((beta_mu[ ,1,2,1] + beta_mu[ ,1,2,2] + beta_mu[ ,1,2,3]) - 
           (beta_mu[ ,1,1,1] + beta_mu[ ,1,1,2] + beta_mu[ ,1,1,3]),probs=c(.025,.975)) / 3
...
sum((beta_mu[ ,2,2,1] + beta_mu[ ,2,2,2] + beta_mu[ ,2,2,3]) - 
      (beta_mu[ ,2,1,1] + beta_mu[ ,2,1,2] + beta_mu[ ,2,1,3])) / 3400 / 3
quantile((beta_mu[ ,2,2,1] + beta_mu[ ,2,2,2] + beta_mu[ ,2,2,3]) - 
           (beta_mu[ ,2,1,1] + beta_mu[ ,2,1,2] + beta_mu[ ,2,1,3]),probs=c(.025,.975)) / 3
# Main effect of experiment
# Exp 1 vs Exp 2
...
sum((beta_mu[ ,1,2,1] + beta_mu[ ,2,2,1] + beta_mu[ ,2,1,1] + beta_mu[ ,1,1,1]) - (beta_mu[ ,1,2,3] + beta_mu[ ,2,2,3] + beta_mu[ ,1,1,3] + beta_mu[ ,2,1,3])) / 3400 / 4
quantile((beta_mu[ ,1,2,1] + beta_mu[ ,2,2,1] + beta_mu[ ,2,1,1] + beta_mu[ ,1,1,1]) - (beta_mu[ ,1,2,3] + beta_mu[ ,2,2,3] + beta_mu[ ,1,1,3] + beta_mu[ ,2,1,3]),probs=c(.025,.975)) / 4
# Exp 2 vs Exp 3
...
sum((beta_mu[ ,1,2,1] + beta_mu[ ,1,2,2] + beta_mu[ ,1,2,3] + 
       beta_mu[ ,2,2,1] + beta_mu[ ,2,2,2] + beta_mu[ ,2,2,3]) - 
      (beta_mu[ ,1,1,1] + beta_mu[ ,1,1,2] + beta_mu[ ,1,1,3] + 
         beta_mu[ ,2,1,1] + beta_mu[ ,2,1,2] + beta_mu[ ,2,1,3])) / 3400 / 6
quantile((beta_mu[ ,1,2,1] + beta_mu[ ,1,2,2] + beta_mu[ ,1,2,3] + 
            beta_mu[ ,2,2,1] + beta_mu[ ,2,2,2] + beta_mu[ ,2,2,3]) - 
           (beta_mu[ ,1,1,1] + beta_mu[ ,1,1,2] + beta_mu[ ,1,1,3] + 
              beta_mu[ ,2,1,1] + beta_mu[ ,2,1,2] + beta_mu[ ,2,1,3]),probs=c(.025,.975)) / 6
...
sum((alpha_N_mu[ ,1,2,1] - alpha_N_mu[ ,1,1,1]) - (alpha_P_mu[ ,1,2,1] - alpha_P_mu[ ,1,1,1])) / 3400 / 2
quantile((alpha_N_mu[ ,1,2,1] - alpha_N_mu[ ,1,1,1]) - (alpha_P_mu[ ,1,2,1] - alpha_P_mu[ ,1,1,1]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,1,2,1] + alpha_P_mu[ ,1,2,1]) - (alpha_N_mu[ ,1,1,1] + alpha_P_mu[ ,1,1,1])) / 3400 / 2
quantile((alpha_N_mu[ ,1,2,1] + alpha_P_mu[ ,1,2,1]) - (alpha_N_mu[ ,1,1,1] + alpha_P_mu[ ,1,1,1]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,2,2,1] - alpha_N_mu[ ,2,1,1]) - (alpha_P_mu[ ,2,2,1] - alpha_P_mu[ ,2,1,1])) / 3400 / 2
quantile((alpha_N_mu[ ,2,2,1] - alpha_N_mu[ ,2,1,1]) - (alpha_P_mu[ ,2,2,1] - alpha_P_mu[ ,2,1,1]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,2,2,1] + alpha_P_mu[ ,2,2,1]) - (alpha_N_mu[ ,2,1,1] + alpha_P_mu[ ,2,1,1])) / 3400 / 2
quantile((alpha_N_mu[ ,2,2,1] + alpha_P_mu[ ,2,2,1]) - (alpha_N_mu[ ,2,1,1] + alpha_P_mu[ ,2,1,1]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,1,2,2] - alpha_N_mu[ ,1,1,2]) - (alpha_P_mu[ ,1,2,2] - alpha_P_mu[ ,1,1,2])) / 3400 / 2
quantile((alpha_N_mu[ ,1,2,2] - alpha_N_mu[ ,1,1,2]) - (alpha_P_mu[ ,1,2,2] - alpha_P_mu[ ,1,1,2]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,1,2,2] + alpha_P_mu[ ,1,2,2]) - (alpha_N_mu[ ,1,1,2] + alpha_P_mu[ ,1,1,2])) / 3400 / 2
quantile((alpha_N_mu[ ,1,2,2] + alpha_P_mu[ ,1,2,2]) - (alpha_N_mu[ ,1,1,2] + alpha_P_mu[ ,1,1,2]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,2,2,2] - alpha_N_mu[ ,2,1,2]) - (alpha_P_mu[ ,2,2,2] - alpha_P_mu[ ,2,1,2])) / 3400 / 2
quantile((alpha_N_mu[ ,2,2,2] - alpha_N_mu[ ,2,1,2]) - (alpha_P_mu[ ,2,2,2] - alpha_P_mu[ ,2,1,2]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,2,2,2] + alpha_P_mu[ ,2,2,2]) - (alpha_N_mu[ ,2,1,2] + alpha_P_mu[ ,2,1,2])) / 3400 / 2
quantile((alpha_N_mu[ ,2,2,2] + alpha_P_mu[ ,2,2,2]) - (alpha_N_mu[ ,2,1,2] + alpha_P_mu[ ,2,1,2]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,1,2,3] - alpha_N_mu[ ,1,1,3]) - (alpha_P_mu[ ,1,2,3] - alpha_P_mu[ ,1,1,3])) / 3400 / 2
quantile((alpha_N_mu[ ,1,2,3] - alpha_N_mu[ ,1,1,3]) - (alpha_P_mu[ ,1,2,3] - alpha_P_mu[ ,1,1,3]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,1,2,3] + alpha_P_mu[ ,1,2,3]) - (alpha_N_mu[ ,1,1,3] + alpha_P_mu[ ,1,1,3])) / 3400 / 2
quantile((alpha_N_mu[ ,1,2,3] + alpha_P_mu[ ,1,2,3]) - (alpha_N_mu[ ,1,1,3] + alpha_P_mu[ ,1,1,3]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,2,2,3] - alpha_N_mu[ ,2,1,3]) - (alpha_P_mu[ ,2,2,3] - alpha_P_mu[ ,2,1,3])) / 3400 / 2
quantile((alpha_N_mu[ ,2,2,3] - alpha_N_mu[ ,2,1,3]) - (alpha_P_mu[ ,2,2,3] - alpha_P_mu[ ,2,1,3]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,2,2,3] + alpha_P_mu[ ,2,2,3]) - (alpha_N_mu[ ,2,1,3] + alpha_P_mu[ ,2,1,3])) / 3400 / 2
quantile((alpha_N_mu[ ,2,2,3] + alpha_P_mu[ ,2,2,3]) - (alpha_N_mu[ ,2,1,3] + alpha_P_mu[ ,2,1,3]), probs=c(.025,.975)) / 2
...
sum((alpha_P_mu[ ,2,2,1] - alpha_P_mu[ ,2,1,1]) - (alpha_P_mu[ ,2,2,2] - alpha_P_mu[ ,2,1,2])) / 3400 / 2
quantile((alpha_P_mu[ ,2,2,1] - alpha_P_mu[ ,2,1,1]) - (alpha_P_mu[ ,2,2,2] - alpha_P_mu[ ,2,1,2]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,2,2,1] - alpha_N_mu[ ,2,1,1]) - (alpha_N_mu[ ,2,2,2] - alpha_N_mu[ ,2,1,2])) / 3400 / 2
quantile((alpha_N_mu[ ,2,2,1] - alpha_N_mu[ ,2,1,1]) - (alpha_N_mu[ ,2,2,2] - alpha_N_mu[ ,2,1,2]), probs=c(.025,.975)) / 2
...
sum(((alpha_P_mu[ ,2,2,1] - alpha_P_mu[ ,2,1,1]) - (alpha_N_mu[ ,2,2,1] - alpha_N_mu[ ,2,1,1])) - ((alpha_P_mu[ ,2,2,2] - alpha_P_mu[ ,2,1,2]) - (alpha_N_mu[ ,2,2,2] - alpha_N_mu[ ,2,1,2]))) / 3400 / 4
quantile(((alpha_P_mu[ ,2,2,1] - alpha_P_mu[ ,2,1,1]) - (alpha_N_mu[ ,2,2,1] - alpha_N_mu[ ,2,1,1])) - ((alpha_P_mu[ ,2,2,2] - alpha_P_mu[ ,2,1,2]) - (alpha_N_mu[ ,2,2,2] - alpha_N_mu[ ,2,1,2])), probs=c(.025,.975)) / 4
# Exp 1 vs Exp 3
...
sum((alpha_P_mu[ ,2,2,1] - alpha_P_mu[ ,2,1,1]) - (alpha_P_mu[ ,2,2,3] - alpha_P_mu[ ,2,1,3])) / 3400 / 2
quantile((alpha_P_mu[ ,2,2,1] - alpha_P_mu[ ,2,1,1]) - (alpha_P_mu[ ,2,2,3] - alpha_P_mu[ ,2,1,3]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,2,2,1] - alpha_N_mu[ ,2,1,1]) - (alpha_N_mu[ ,2,2,3] - alpha_N_mu[ ,2,1,3])) / 3400 / 2
quantile((alpha_N_mu[ ,2,2,1] - alpha_N_mu[ ,2,1,1]) - (alpha_N_mu[ ,2,2,3] - alpha_N_mu[ ,2,1,3]), probs=c(.025,.975)) / 2
...
sum(((alpha_P_mu[ ,2,2,1] - alpha_P_mu[ ,2,1,1]) - (alpha_N_mu[ ,2,2,1] - alpha_N_mu[ ,2,1,1])) - ((alpha_P_mu[ ,2,2,3] - alpha_P_mu[ ,2,1,3]) - (alpha_N_mu[ ,2,2,3] - alpha_N_mu[ ,2,1,3]))) / 3400 / 4
quantile(((alpha_P_mu[ ,2,2,1] - alpha_P_mu[ ,2,1,1]) - (alpha_N_mu[ ,2,2,1] - alpha_N_mu[ ,2,1,1])) - ((alpha_P_mu[ ,2,2,3] - alpha_P_mu[ ,2,1,3]) - (alpha_N_mu[ ,2,2,3] - alpha_N_mu[ ,2,1,3])), probs=c(.025,.975)) / 4
# Exp 2 vs Exp 3
...
sum((alpha_P_mu[ ,2,2,2] - alpha_P_mu[ ,2,1,2]) - (alpha_P_mu[ ,2,2,3] - alpha_P_mu[ ,2,1,3])) / 3400 / 2
quantile((alpha_P_mu[ ,2,2,2] - alpha_P_mu[ ,2,1,2]) - (alpha_P_mu[ ,2,2,3] - alpha_P_mu[ ,2,1,3]), probs=c(.025,.975)) / 2
...
sum((alpha_N_mu[ ,2,2,2] - alpha_N_mu[ ,2,1,2]) - (alpha_N_mu[ ,2,2,3] - alpha_N_mu[ ,2,1,3])) / 3400 / 2
quantile((alpha_N_mu[ ,2,2,2] - alpha_N_mu[ ,2,1,2]) - (alpha_N_mu[ ,2,2,3] - alpha_N_mu[ ,2,1,3]), probs=c(.025,.975)) / 2
...
sum(((alpha_P_mu[ ,2,2,2] - alpha_P_mu[ ,2,1,2]) - (alpha_N_mu[ ,2,2,2] - alpha_N_mu[ ,2,1,2])) - ((alpha_P_mu[ ,2,2,3] - alpha_P_mu[ ,2,1,3]) - (alpha_N_mu[ ,2,2,3] - alpha_N_mu[ ,2,1,3]))) / 3400 / 4
quantile(((alpha_P_mu[ ,2,2,2] - alpha_P_mu[ ,2,1,2]) - (alpha_N_mu[ ,2,2,2] - alpha_N_mu[ ,2,1,2])) - ((alpha_P_mu[ ,2,2,3] - alpha_P_mu[ ,2,1,3]) - (alpha_N_mu[ ,2,2,3] - alpha_N_mu[ ,2,1,3])), probs=c(.025,.975)) / 4
# Main effect of experiment
# Exp 1 vs Exp 2
...
sum(((alpha_P_mu[ ,2,2,1] + alpha_P_mu[ ,2,2,2] + alpha_P_mu[ ,2,2,3] + alpha_N_mu[ ,2,2,1] + alpha_N_mu[ ,2,2,2] + alpha_N_mu[ ,2,2,3]) - 
       (alpha_P_mu[ ,2,1,1] + alpha_P_mu[ ,2,1,2] + alpha_P_mu[ ,2,1,3] + alpha_N_mu[ ,2,1,1] + alpha_N_mu[ ,2,1,2] + alpha_N_mu[ ,2,1,3]))) / 3400 / 6
quantile(((alpha_P_mu[ ,2,2,1] + alpha_P_mu[ ,2,2,2] + alpha_P_mu[ ,2,2,3] + alpha_N_mu[ ,2,2,1] + alpha_N_mu[ ,2,2,2] + alpha_N_mu[ ,2,2,3]) - 
            (alpha_P_mu[ ,2,1,1] + alpha_P_mu[ ,2,1,2] + alpha_P_mu[ ,2,1,3] + alpha_N_mu[ ,2,1,1] + alpha_N_mu[ ,2,1,2] + alpha_N_mu[ ,2,1,3])), probs=c(.025,.975)) / 6
...
sum(((alpha_P_mu[ ,2,1,1] + alpha_P_mu[ ,2,1,2] + alpha_P_mu[ ,2,1,3] + alpha_P_mu[ ,2,2,1] + alpha_P_mu[ ,2,2,2] + alpha_P_mu[ ,2,2,3]) - 
       (alpha_N_mu[ ,2,1,1] + alpha_N_mu[ ,2,1,2] + alpha_N_mu[ ,2,1,3] + alpha_N_mu[ ,2,2,1] + alpha_N_mu[ ,2,2,2] + alpha_N_mu[ ,2,2,3]))) / 3400 / 6
quantile(((alpha_P_mu[ ,2,1,1] + alpha_P_mu[ ,2,1,2] + alpha_P_mu[ ,2,1,3] + alpha_P_mu[ ,2,2,1] + alpha_P_mu[ ,2,2,2] + alpha_P_mu[ ,2,2,3]) - 
            (alpha_N_mu[ ,2,1,1] + alpha_N_mu[ ,2,1,2] + alpha_N_mu[ ,2,1,3] + alpha_N_mu[ ,2,2,1] + alpha_N_mu[ ,2,2,2] + alpha_N_mu[ ,2,2,3])), probs=c(.025,.975)) / 6
