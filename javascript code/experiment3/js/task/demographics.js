    ...
    const quest = function () {
        ...
        document.querySelector("#main-display").innerHTML =
            `<div class="content-display flex items-center flex-column" >
             ...
             <div style="width:80%;">
                <p class="question-header">1) Gender:</p>
                ...
                <p class="question-header">2) Race:</p>
                ...
                <p class="question-header">3) Are you colorblind?</p>
                ...
                <p class="question-header">4) Do you have corrected or corrected-to-normal vision?</p>
                ...
                <p><span class="question-header">5) Age:</span>
                    <input name="age" id="age" type="text" required> </p>

                <p class="question-header">6) Ethnicity (e.g., Hispanic, Latino, Chinese, Japanese, Arab, Multiple Ethnicities, "Do not wish to reply", etc.):
